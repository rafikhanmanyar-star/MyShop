              ...
              <tbody>
                {summary.byCashier.map((c: any) => (
                  <tr key={c.cashierId} className="border-b border-slate-100">
                    ...
                    <td className={`py-2 pr-4 ${Number(c.varianceSum) < 0 ? 'text-rose-600' : Number(c.varianceSum) > 0 ? 'text-emerald-600' : ''}`}>
                  ...
                  <tr key={s.id} className="border-b border-slate-100 hover:bg-slate-50/50">
                    ...
                    <td className="p-3">
                      {s.variance_amount != null ? (
                        <span className={Number(s.variance_amount) < 0 ? 'text-rose-600' : 'text-emerald-600'}>
                    ...
                    <td className="p-3">
                      {s.status === 'closed' && (
                        <button
                          ...
                          className="inline-flex items-center gap-1 px-2 py-1 rounded-lg bg-amber-100 text-amber-800 text-xs font-medium hover:bg-amber-200 disabled:opacity-50"
                        >
