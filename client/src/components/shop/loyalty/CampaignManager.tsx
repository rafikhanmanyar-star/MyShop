    ...
    return (
        <div className="space-y-6 animate-fade-in shadow-inner">
            <div className="flex justify-between items-center mb-4">
                <h3 className="text-lg font-black text-foreground tracking-tight">Promotional Campaign Lifecycle</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {campaigns.map(camp => (
                    <Card key={camp.id} className="relative overflow-hidden group border-none shadow-sm hover:shadow-xl transition-all h-[320px] flex flex-col p-8 bg-card border-b-4 border-border">
                        {/* Status Overlay */}
                        ...
                        <div className="flex-1 space-y-2">
                            <h4 className="text-xl font-black text-foreground tracking-tight group-hover:text-rose-600 transition-colors">{camp.name}</h4>
                            ...
                            <div className="pt-6 space-y-4">
                                <div className="flex items-center justify-between text-[10px] font-bold">
                                    ...
                                    <span className="text-foreground bg-muted px-2 py-0.5 rounded italic">{camp.targetSegment}</span>
                                </div>
                                <div className="flex items-center justify-between text-[10px] font-bold">
                        ...
                        <div className="pt-6 border-t border-slate-50 flex gap-2">
                            <button className="flex-1 py-3 bg-muted/80 text-muted-foreground rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-muted transition-all">
                                Edit Campaign
                            </button>
                            <button className="px-3 bg-muted text-muted-foreground rounded-xl hover:bg-rose-50 hover:text-rose-600 transition-all">
                                {ICONS.trash}
                            </button>
                        </div>
                    </Card>
                ...
                <button className="h-[320px] border-4 border-dashed border-border rounded-3xl flex flex-col items-center justify-center gap-4 text-slate-300 hover:border-rose-300 hover:text-rose-400 transition-all group p-12">
                    <div className="w-16 h-16 bg-muted/80 rounded-full flex items-center justify-center group-hover:bg-rose-50 transition-colors">
                    ...
                    <div className="text-center">
                        ...
                        <p className="text-[10px] font-medium italic mt-1 bg-muted/80 px-2 py-0.5 rounded">Deploy high-ROI retention rules</p>
                    </div>
                </button>
            </div>
        </div>
