    ...
    return (
        <div className="space-y-8 animate-fade-in text-foreground">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                {/* Engagement Overview */}
                <Card className="lg:col-span-2 border-none shadow-sm p-8 bg-card relative overflow-hidden">
                    ...
                    <div className="h-64 flex items-end gap-4 px-4 pb-4 border-b border-border">
                        {[45, 62, 85, 30, 95, 70, 55].map((val, i) => (
                            <div key={i} className="flex-1 bg-rose-50 rounded-t-xl relative group transition-all hover:bg-rose-500 h-[20%] hover:h-[90%]" style={{ height: `${val}%` }}>
                                <div className="absolute -top-8 left-1/2 -translate-x-1/2 opacity-0 group-hover:opacity-100 text-[10px] font-black text-rose-600 bg-card shadow-sm px-2 py-1 rounded border border-rose-100 whitespace-nowrap">
                                    {val}% Retention
                                </div>
                            </div>
                        ))}
                ...
                <Card className="border-none shadow-sm p-6 space-y-6 flex flex-col">
                    ...
                    <div className="flex-1 flex flex-col justify-center items-center gap-6">
                        ...
                        <div className="grid grid-cols-2 gap-4 w-full">
                            <div className="p-3 bg-muted/80 rounded-xl border border-border">
