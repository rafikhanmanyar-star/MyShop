...
const ShopPlaceholder: React.FC<ShopPlaceholderProps> = ({ title, description, icon }) => {
    return (
        <div className="w-full min-w-0 space-y-6">
            ...
            <Card className="p-12 flex flex-col items-center justify-center text-center space-y-4 border-dashed border-2 bg-muted/80/50">
                ...
                <div>
                    <h3 className="text-xl font-bold text-foreground">Module Under Development</h3>
                    <p className="text-muted-foreground max-w-sm mx-auto mt-2">
                        We are currently building the {title} module. This enterprise-level feature will be available soon.
                    </p>
                </div>
                <div className="flex gap-3 mt-4">
                    <div className="px-4 py-2 bg-card rounded-lg border border-border text-sm font-medium text-muted-foreground shadow-sm">
                        Enterprise Grade
                    </div>
                    <div className="px-4 py-2 bg-card rounded-lg border border-border text-sm font-medium text-muted-foreground shadow-sm">
                        Real-time Sync
