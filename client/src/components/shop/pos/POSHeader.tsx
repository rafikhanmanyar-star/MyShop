...
const POSHeader: React.FC = () => {
    ...
    return (
        <div className="bg-white dark:bg-slate-900 border-b border-slate-200/90 dark:border-slate-700 z-30 sticky top-0 flex-shrink-0 shadow-[0_1px_0_rgba(0,0,0,0.04)]">
            ...
            {/* Right: Session time, F12 hint, user */}
            <div className="flex items-center gap-2 md:gap-4 flex-shrink-0 min-w-0">
                ...
                <div className="flex items-center gap-2 md:gap-3 pl-3 md:pl-5 border-l border-slate-200 dark:border-slate-700 min-w-0">
                    <div className="flex flex-col items-end min-w-0">
                        ...
                        <span className="text-xs font-bold text-[#0056b3] dark:text-blue-400 uppercase tracking-wider mt-0.5 truncate">
                            {user?.role?.replace('_', ' ') || 'Manager'}
                        </span>
                    </div>
                    <div className="relative flex-shrink-0">
                        <div className="w-9 h-9 md:w-10 md:h-10 rounded-full bg-[#eef2ff] dark:bg-slate-800 border border-slate-200/80 dark:border-slate-700 flex items-center justify-center overflow-hidden">
                            <span className="text-sm font-bold text-[#0056b3] dark:text-slate-300">{user?.name?.charAt(0) || 'A'}</span>
                        </div>
                        <div className="absolute bottom-0 right-0 w-2.5 h-2.5 md:w-3 md:h-3 bg-emerald-500 border-2 border-white dark:border-slate-900 rounded-full" />
                    </div>
                </div>
            </div>
        </div>
