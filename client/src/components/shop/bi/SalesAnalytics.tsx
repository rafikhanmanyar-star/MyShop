    ...
    return (
        <div className="space-y-8 animate-in slide-in-from-right duration-700">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <Card className="border-none shadow-sm p-6 bg-card space-y-4">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                {/* Category Mix */}
                <Card className="border-none shadow-sm p-8 bg-card flex flex-col gap-8">
                    <h4 className="font-bold text-foreground uppercase tracking-widest text-[10px]">Revenue by Category Mix</h4>
                            ...
                            return (
                                <div key={i} className="space-y-3 cursor-pointer group">
                                    <div className="flex justify-between items-end">
                                        <div>
                                            <p className="text-sm font-black text-foreground group-hover:text-indigo-600 transition-colors">{cat.category}</p>
                                    ...
                                    <div className="h-3 bg-muted/80 rounded-full overflow-hidden flex">
                                        <div
                ...
                <Card className="border-none shadow-sm p-8 bg-card space-y-8">
                    <div className="flex justify-between items-center">
                        <h4 className="font-bold text-foreground uppercase tracking-widest text-[10px]">Daily Revenue Trend</h4>
                    ...
                    <div className="h-48 flex items-end gap-1 group/chart border-b border-border">
            ...
            <Card className="border-none shadow-sm overflow-hidden bg-card">
                <div className="p-6 border-b border-slate-50 bg-muted/80/50 flex justify-between items-center">
                    <h4 className="font-bold text-foreground text-sm">Recent Transactions (All Sources)</h4>
                    ...
                    <table className="w-full text-left">
                        ...
                        <tbody className="divide-y divide-slate-50 text-xs">
                            {recentTransactions.length > 0 ? recentTransactions.slice(0, 10).map((tx: any, i: number) => (
                                <tr key={i} className="hover:bg-muted/50 transition-colors font-medium">
