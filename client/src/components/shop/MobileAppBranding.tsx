    ...
    const loadBranding = async () => {
        try {
            ...
            setBranding({
                ...
                home_promo_interval_seconds: clampHomePromoIntervalSeconds(data.home_promo_interval_seconds),
            });
        } catch (error) {
                ...
                <div className="space-y-6">
                    ...
                    <Card className="p-0 overflow-hidden border-0 shadow-none bg-transparent">
                        <HomePromoAdsEditor
                            variant="card"
                            value={{
                                home_promo_slides: branding.home_promo_slides,
                                home_promo_interval_seconds: branding.home_promo_interval_seconds,
                            }}
                            onChange={(patch) => setBranding({ ...branding, ...patch })}
                        />
                    </Card>
                        ...
                        >
                            ...
                            <div className="flex-1 p-6 space-y-6 overflow-y-auto">
                                ...
                                <div className="rounded-2xl overflow-hidden border border-border bg-slate-100 aspect-[16/9] flex items-center justify-center relative">
                                    {branding.home_promo_slides?.[0]?.image_url ? (
                                        <img
                                            src={getFullImageUrl(branding.home_promo_slides[0].image_url)}
                                            alt=""
