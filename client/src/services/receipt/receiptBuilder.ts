...
body { font-family: 'Courier New', Courier, monospace; width: ${bodyWidth}mm; padding: ${bodyPadding}; font-size: ${fontSize}; line-height: 1.2; color: #000; background: #fff; margin: 0; box-sizing: border-box; }
