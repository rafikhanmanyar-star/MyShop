/** Pure pricing helpers for promotional offers (unit-tested). */
...
/**
 * For one bundle set: compute final subtotal after offer rules and total discount from undiscounted base.
 */
...
/** Split total discount across lines proportionally by pre-discount line value; fixes rounding on last line. */
