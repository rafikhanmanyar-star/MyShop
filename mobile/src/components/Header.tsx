                            ...
                            <div className="user-menu scale-in">
                                {state.isLoggedIn ? (
                                    <>
                                        ...
                                        <Link to={`/${shopSlug}/voice-orders`} className="menu-item" onClick={() => setShowMenu(false)}>
                                        ...
                                        <div className="menu-divider" />
                                        <button className="menu-item logout" onClick={() => { dispatch({ type: 'LOGOUT' }); setShowMenu(false); navigate(`/${shopSlug}/login`); }}>
